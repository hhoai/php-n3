        ...
        <div class="footer-container">
          <div class="footer-container-left">
            <div class="container">
              ...
              <a href="../../index.php" class="container-items">Trang chủ</a>
              <a href="../../page/introduction/" class="container-items">Giới thiệu</a>
              <a href="../../page/contact/" class="container-items">Liên hệ</a>
            </div>
            <div class="container">
              <div class="container-h">Hỗ trợ</div>
              <a href="../../page/introduction/" class="container-items"
                >Giới thiệu chung</a
              >
              <a href="../../page/saleActivity/" class="container-items"
